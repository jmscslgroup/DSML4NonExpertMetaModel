...
define([
...
], function (CONSTANTS, nodePropertyNames, DiagramDesignerWidgetDecoratorBase, CanyonViewDecoratorTemplate) {

    'use strict';

    var DECORATOR_ID = 'CanyonViewDecorator';

    function CanyonViewDecorator(options) {
    ...
    _.extend(CanyonViewDecorator.prototype, DiagramDesignerWidgetDecoratorBase.prototype);
    ...
    CanyonViewDecorator.prototype.on_addTo = function () {
        var self = this;
    ...
    CanyonViewDecorator.prototype.getConnectionAreas = function (id /*, isEnd, connectionMetaInfo*/) {
        var result = [],
            edge = 10,
            LEN = 20;
    ...
    CanyonViewDecorator.prototype._onNodeTitleChanged = function (oldValue, newValue) {
        var client = this._control._client;
